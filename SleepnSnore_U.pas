...
type
  TfrmSleepnSnore = class(TForm)
    ...
    procedure lblContactUsSleepnSnoreClick(Sender: TObject);
    ...
    procedure imgHelpSleepnSnoreClick(Sender: TObject);
...
var
  frmSleepnSnore: TfrmSleepnSnore;
...
procedure TfrmSleepnSnore.btnBookR1L1Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR1L2Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR2L1Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR2L2Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR3L1Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR3L2Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR4L1Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnBookR4L2Click(Sender: TObject);
begin
  CloseAll;
...
procedure TfrmSleepnSnore.btnLogoutClick(Sender: TObject);
var
  iSure : ShortInt;
...
{Checks if rooms are available by using the start date and number of days the user
 ...
 that period}
procedure TfrmSleepnSnore.CheckAvailable;
var
...
procedure TfrmSleepnSnore.CloseAll;
begin
  bR1L1 := False;
  bR2L1 := False;
  bR3L1 := False;
...
procedure TfrmSleepnSnore.DateTimePickerStartChange(Sender: TObject);
begin
  tStartDate := DateTimePickerStart.Date;
  frmPickDate.StartDate;
end;

procedure TfrmSleepnSnore.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Application.Terminate;
end;

procedure TfrmSleepnSnore.FormMouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.FormShow(Sender: TObject);
var
  tTemp: TextFile;
  sTemp: string;
...
procedure TfrmSleepnSnore.grpbLevel1MouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.grpbLevel2MouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.imgAccClick(Sender: TObject);
begin
  Self.Hide;
  frmStdUser.Show;
end;

procedure TfrmSleepnSnore.imgBackClick(Sender: TObject);
begin
  if bLogin = True then
  begin
    Self.Hide;
...
procedure TfrmSleepnSnore.imgBackgroundMouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.imgBackMouseEnter(Sender: TObject);
begin
  ShapeBackStd.Visible := True;
  CloseAll;
end;

procedure TfrmSleepnSnore.imgBackMouseLeave(Sender: TObject);
begin
  ShapeBackStd.Visible := False;
end;

procedure TfrmSleepnSnore.imgHelpSleepnSnoreClick(Sender: TObject);
begin
  Self.Enabled := False;
...
procedure TfrmSleepnSnore.imgLogoMouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.imgR1L1MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR1L1 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR1L2MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR1L2 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR2L1MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR2L1 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR2L2MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR2L2 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR3L1MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR3L1 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR3L2MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR3L2 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR4L1MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR4L1 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.imgR4L2MouseEnter(Sender: TObject);
begin
  CloseAll;
  bR4L2 := True;
  Timer1.Enabled := True;
...
procedure TfrmSleepnSnore.lblContactUsSleepnSnoreClick(Sender: TObject);
begin
  Self.Hide;
  iForm := 3;
...
procedure TfrmSleepnSnore.lblLevel1Click(Sender: TObject);
begin
...
procedure TfrmSleepnSnore.lblLevel1MouseEnter(Sender: TObject);
begin
  if lblLevel1.Font.Style = [] then
    lblLevel1.Cursor := crHandPoint;
end;

procedure TfrmSleepnSnore.lblLevel1MouseLeave(Sender: TObject);
begin
  lblLevel1.Cursor := crDefault;
end;

procedure TfrmSleepnSnore.lblLevel2Click(Sender: TObject);
begin
...
procedure TfrmSleepnSnore.lblLevel2MouseEnter(Sender: TObject);
begin
  if lblLevel2.Font.Style = [] then
    lblLevel2.Cursor := crHandPoint;
end;

procedure TfrmSleepnSnore.lblLevel2MouseLeave(Sender: TObject);
begin
  lblLevel2.Cursor := crDefault;
end;

procedure TfrmSleepnSnore.lblSignInClick(Sender: TObject);
begin
  Self.Hide;
  frmLogin.Show;
end;

procedure TfrmSleepnSnore.lblSignInMouseEnter(Sender: TObject);
begin
  lblSignIn.Font.Color := clRed;
end;

procedure TfrmSleepnSnore.lblSignInMouseLeave(Sender: TObject);
begin
  lblSignIn.Font.Color := clWhite;
end;

procedure TfrmSleepnSnore.lblSignUpClick(Sender: TObject);
begin
  Self.Hide;
  frmRegister.Show;
end;

procedure TfrmSleepnSnore.lblSignUpMouseEnter(Sender: TObject);
begin
  lblSignUp.Font.Color := clRed;
end;

procedure TfrmSleepnSnore.lblSignUpMouseLeave(Sender: TObject);
begin
...
procedure TfrmSleepnSnore.OpenBooking;
var
  iBook : ShortInt;
...
procedure TfrmSleepnSnore.R1NA;
begin
...
procedure TfrmSleepnSnore.R2NA;
begin
...
procedure TfrmSleepnSnore.R3NA;
begin
...
procedure TfrmSleepnSnore.R4NA;
begin
...
procedure TfrmSleepnSnore.R5NA;
begin
...
procedure TfrmSleepnSnore.R6NA;
begin
...
procedure TfrmSleepnSnore.R7NA;
begin
...
procedure TfrmSleepnSnore.R8NA;
begin
...
procedure TfrmSleepnSnore.redDescR1L1SelectionChange(Sender: TObject);
begin
  redDescR1L1.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR1L2SelectionChange(Sender: TObject);
begin
  redDescR1L2.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR2L1SelectionChange(Sender: TObject);
begin
  redDescR2L1.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR2L2SelectionChange(Sender: TObject);
begin
  redDescR2L2.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR3L1SelectionChange(Sender: TObject);
begin
  redDescR3L1.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR3L2SelectionChange(Sender: TObject);
begin
  redDescR3L2.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR4L1SelectionChange(Sender: TObject);
begin
  redDescR4L1.SelLength := 0;
end;

procedure TfrmSleepnSnore.redDescR4L2SelectionChange(Sender: TObject);
begin
  redDescR4L2.SelLength := 0;
end;

procedure TfrmSleepnSnore.ShapeBackStdMouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.spnNumDaysChange(Sender: TObject);
begin
  iNumDays := spnNumDays.Value;
  frmPickDate.NumDays;
end;

procedure TfrmSleepnSnore.TabSheet1MouseEnter(Sender: TObject);
begin
  CloseAll;
end;

procedure TfrmSleepnSnore.Timer1Timer(Sender: TObject);
var
  I: Integer;
...
procedure TfrmSleepnSnore.Timer2Timer(Sender: TObject);
begin
